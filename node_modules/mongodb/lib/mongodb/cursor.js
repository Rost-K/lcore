 ...
 *  - **hint**  {Object}, hint force the query to use a specific config.
 ...
 *  - **returnKey** {Boolean}, returnKey only return the config key.
 *  - **maxScan** {Number}, maxScan limit the number of items to scan.
 *  - **min** {Number}, min set config bounds.
 *  - **max** {Number}, max set config bounds.
